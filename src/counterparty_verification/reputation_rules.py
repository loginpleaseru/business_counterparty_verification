...
(`agents.ReputationAgent`) that does the actual aggregation. Its result is
accepted only after evidence validation.
...
from .domain import CounterpartyCard, Evidence, SourceRiskFactor
